    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-lg grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="mt-5 w-full bg-white/10 text-white border border-gray-700 rounded-xl py-2.5 text-sm font-semibold text-center group-hover:bg-white/15 transition-colors">
            Join queue
          </div>
        </button>
      </div>
